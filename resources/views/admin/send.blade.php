<x-masterPage>
   ...
   <div class="card-body">
    ...
    <h4 class="card-title mb-4">Send Money Transactions</h4>
            ...
            if (response.status == 200) {
                ...
                $.each(response.request, function(key, item) {
                    ...
                    if (item.status == 0) {
                        ...
                        actionButtons = '<td>\
                            <div class="d-flex gap-2 flex-wrap"> <div class="btn-group"><button type="button" class="btn btn-info btn-sm dropdown-toggle hearder" data-bs-toggle="dropdown" aria-expanded="false"> Action <i class="mdi mdi-chevron-down"></i></button> <div class="dropdown-menu"><div class="dropdown-header noti-title"><h5 class="font-size-13 text-muted text-truncate mn-0">Welcome ' + response.user + '!</h5></div>\
